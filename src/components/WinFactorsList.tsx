  ...
  return (
    <div>
      ...
      <p style={{ color: '#475569', fontSize: '0.68rem', lineHeight: 1.5, margin: '16px 0 0', borderTop: '1px solid #2A2F3A', paddingTop: 10 }}>
        En <span style={{ color: '#00E5A0', fontWeight: 700 }}>vert</span>, les points forts à cultiver : l'équipe gagne davantage quand ces
        statistiques sont hautes. En <span style={{ color: '#EF4444', fontWeight: 700 }}>rouge</span>, les points à surveiller : mieux vaut
        les garder bas pour l'emporter.
      </p>
    </div>
  );
}
