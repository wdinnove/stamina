                      ...
                      <table className="stat-table" style={{ width: '100%', borderCollapse: 'collapse', minWidth: 700 }}>
                        <thead>
                          <tr>
                            ...
                            <th style={{ ...TH, textAlign: 'left', width: 160, minWidth: 160, maxWidth: 160 }}>Joueur</th>
                          ...
                          {individualStats.length > 1 && (() => {
                            ...
                            return (
                              <tr key="totals" style={{ borderTop: '2px solid #2A2F3A', backgroundColor: 'rgba(255,255,255,0.035)' }}>
                                ...
                                <td style={{ ...TD, textAlign: 'left', width: 160, minWidth: 160, maxWidth: 160, color: '#64748B', fontWeight: 700, fontSize: '0.68rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Totaux</td>
                      ...
                      <table className="stat-table" style={{ width: '100%', borderCollapse: 'collapse', minWidth: 800 }}>
                        <thead>
                          <tr>
                            ...
                            <th rowSpan={2} style={{ ...TH, textAlign: 'left', width: 160, minWidth: 160, maxWidth: 160, verticalAlign: 'middle', borderBottom: '1px solid #2A2F3A' }}>Joueur</th>
