...
const normalDims = dimensions.filter(d => !d.inverted);
        ...
        <div style={{ backgroundColor: '#161920', border: '1px solid #2A2F3A', borderRadius: 8, padding: '24px' }}>
          <div style={{ marginBottom: 20, display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap' }}>
              ...
              {existingEntryId && (
                <div style={{ padding: '3px 10px', borderRadius: 5, backgroundColor: 'rgba(0,229,160,0.08)', border: '1px solid rgba(0,229,160,0.2)', color: '#00E5A0', fontSize: '0.75rem', fontWeight: 600, whiteSpace: 'nowrap' }}>
          ...
          {entryMode === 'single' ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2" style={{ gap: 20 }}>
              {[normalDims, invertedDims].map((group, groupIdx) => (
